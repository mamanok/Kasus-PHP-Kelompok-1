    ...
    <form action="" method="post" enctype="multipart/form-data">
        <ul>
            <li>
                ...
                <input type="text" name="nis" id="nis" value="Flower Dress" required>
            </li>
            <li>
                <label for="nama">Harga :</label><br>
                <input type="text" name="nama" id="nama" value="Rp 350.000" required>
            </li>
            <li>
            ...
            <li>
                ...
                <input type="text" name="jurusan" id="jurusan" value="Transfer" required>
            </li>
